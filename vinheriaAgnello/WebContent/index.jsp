	...
	<body>
		...
		<div class="container">
			...
			<div class="imagem">
				...
				<input type="button" class="botao" value="Conheça nossos rótulos">
			...
			<div class="produtosVendidos">
				...
				<div class="bebidasDisplay3">
					<img src="content/img/CasalGarcia_Rose-scaled 2.png">
			...
			<div id="produtosPresenteaveis">
				<div class="presenteaveisHarmonia">
					...
					<input type="button" class="botaoPresenteaveis" value="Presenteaveis">
						
				</div>
				
				<div class="presenteaveisImagem">
					<img src="content/img/pexels-pixabay-248413 1.png">
				</div>
			</div>
